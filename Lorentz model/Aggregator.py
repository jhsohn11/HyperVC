...
class GATAggregator(nn.Module):
    ...
    def predict(self, s_history, s, r, ent_embeds, rel_embeds, graph_dict, global_emb, reverse):
        ...
        s_len_non_zero, s_hist_t_sorted, s_tem, r_tem, g, node_ids_graph, global_emb_list = get_s_r_embed_rgcn(
                               ([s_hist], [s_hist_t]), s.view(-1,1), r.view(-1,1), ent_embeds, graph_dict, global_emb)
